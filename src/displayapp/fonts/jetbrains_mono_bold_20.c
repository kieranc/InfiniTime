...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 4253, .adv_w = 400, .box_w = 25, .box_h = 20, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4316, .adv_w = 320, .box_w = 20, .box_h = 20, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4366, .adv_w = 360, .box_w = 22, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4424, .adv_w = 400, .box_w = 25, .box_h = 20, .ofs_x = 0, .ofs_y = -3}
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 61441, .range_length = 1887, .glyph_id_start = 160,
