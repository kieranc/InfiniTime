...
#ifndef OPEN_SANS_LIGHT_1BPP
#define OPEN_SANS_LIGHT_1BPP 1
#endif

#if OPEN_SANS_LIGHT_1BPP
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t open_sans_light_1bpp = {
#else
lv_font_t open_sans_light_1bpp = {
#endif
