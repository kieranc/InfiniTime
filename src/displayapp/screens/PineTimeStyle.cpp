...
PineTimeStyle::PineTimeStyle(DisplayApp* app,
  ...
  lv_obj_set_style_local_text_font(timeD1, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &open_sans_light_4bpp);
  ...
  lv_obj_set_style_local_text_font(timeD2, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &open_sans_light_4bpp);
  ...
  lv_obj_set_style_local_text_font(timeD3, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &open_sans_light_4bpp);
  ...
  lv_obj_set_style_local_text_font(timeD4, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &open_sans_light_4bpp);
