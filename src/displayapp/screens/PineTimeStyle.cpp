...
void PineTimeStyle::Refresh() {
  ...
  if (currentDateTime.IsUpdated()) {
    ...
    if (displayedHour != hour || displayedMinute != minute) {
      ...
      lv_label_set_text_fmt(timeD1, "%i", (hour / 10 % 10));
      lv_label_set_text_fmt(timeD2, "%i", (hour % 10));
      lv_label_set_text_fmt(timeD3, "%i", (minute / 10 % 10));
      lv_label_set_text_fmt(timeD4, "%i", (minute % 10));
